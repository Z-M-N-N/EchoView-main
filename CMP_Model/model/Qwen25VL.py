...
def main():
    ...
    parser.add_argument('--model_path', type=str, default="/home/mzhao/公共大模型/Qwen2.5-VL-7B-Instruct", help='基础模型路径')
    ...
    parser.add_argument('--diag_item_config', type=str, default="/home/mzhao/ECHO_VIEW/EchoView-main/DATA_BUILDER/diag_info.json", help='LoRA权重路径')
...
# python inference.py \
# --model_path "/home/mzhao/ECHO_VIEW/weights/vlm_best_merged_model_only_video_merged" \
# --data_path "/home/mzhao/ECHO_VIEW/SFT_JSON/only_video/test/" \
# --sample_size 200 \
# --save_results "/home/mzhao/ECHO_VIEW/实验结果/实验一四模式对比/only_video"


# python inference.py \
# --model_path "/home/mzhao/ECHO_VIEW/weights/vlm_best_merged_model_multi_video_merged" \
# --data_path "/home/mzhao/ECHO_VIEW/SFT_JSON/multi_video/test/" \
# --sample_size 200 \
# --save_results "/home/mzhao/ECHO_VIEW/实验结果/实验一四模式对比/multi_video"


# python inference.py \
# --model_path "/home/mzhao/ECHO_VIEW/weights/vlm_best_merged_model_all_video_merged" \
# --data_path "/home/mzhao/ECHO_VIEW/SFT_JSON/all_video/test/" \
# --sample_size 200 \
# --save_results "/home/mzhao/ECHO_VIEW/实验结果/实验一四模式对比/all_video"